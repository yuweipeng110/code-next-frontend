...
/**
 * 用户中心-明细列表-关注-关注的团队列表
 */
const UserCenterDetailListFollowTeams = () => {
    return (
        <div className='user-center-detail-list-follow-teams'>
            <List
...
export default UserCenterDetailListFollowTeams;