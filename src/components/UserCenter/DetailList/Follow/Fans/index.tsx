 ...
 * 用户中心-明细列表-关注-粉丝列表
 */
const UserCenterDetailListFollowFans = () => {
    console.log('UserCenterDetailListFollowFans')
    return (
        <div className='user-center-detail-list-follow-fans'>
            <List
...
export default UserCenterDetailListFollowFans;