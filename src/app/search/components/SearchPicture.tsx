...
import { Card, Empty, List, Skeleton, Image } from 'antd';
 ...
 * @returns 
 */
const SearchPicture: React.FC<Props> = React.memo((props) => {

    const { data, total, loadMoreData, keyword } = props;

    const cardView = (item: API.Picture) => {
        return (
            <Card
                bordered
                cover={<Image
            ...
            <List
                ...
                renderItem={(item) =>
                    <List.Item>
                        <Card
                            bordered
                            cover={<Skeleton.Image active className="skeleton-card-image" />}
                        >
                            <Card.Meta
                                style={{
                                    textAlign: 'center',
                                }}
                                title={<Skeleton.Button active block />}
                            />
                        </Card>
                    </List.Item>
                }
